...
def get_source_server_ids():
    ...
    for i in response['items']:
        ...
        if i['dataReplicationInfo']['dataReplicationState'] == 'DISCONNECTED' or 'CUTOVER' or 'DISCOVERED':
            continue
        else:
            if i['Operating System'] == 'Windows':
